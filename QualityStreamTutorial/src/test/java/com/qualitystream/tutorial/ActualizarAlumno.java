...
public class ActualizarAlumno {
	...
	By editarBtnLocator = By.name("editar");
	@Before
	public void setUp() {
	...
	public void testActualizar() {
		driver.findElement(editarBtnLocator).click();
		driver.findElement(nombreLocator).clear();
		driver.findElement(nombreLocator).sendKeys("Raul");
